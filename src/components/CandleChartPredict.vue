  ...
  <section>
    <b-navbar type="is-dark">
        ...
        <template #start>
            ...
            <b-navbar-item @click="$router.push('/chartrealtime')">
                Dữ liệu
            </b-navbar-item>
...
<!--     <b-button @click="open=true; $refs.candleRef.change_toolbar(false)">Show</b-button> -->
    <CandleChart v-show=true ref="candleRef" :hexData="String(hex_code).toUpperCase()"/>
...
export default {
  name: 'ChartLogin',
  components: {
    CandleChart, UserStatus,// CheckToken,
  },
  computed: {
